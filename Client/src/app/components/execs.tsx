...
export default function Execs({ execs }: { execs: Exec[] }) {
    return (
        <div className="flex flex-wrap justify-center items-center my-10 mx-auto w-2/3 col">
            {execs.map((data: Exec, index) => (
                <div key={index}>
                    <Tilt
                        ...
                        {data.url ?
                            <a className="flex z-50 flex-col justify-center items-center" href={"https://" + data.url} target="_blank" rel="noopener noreferrer">
                                <Image
                                    width={100}
                                    height={100}
                                    alt={data.alt}
                                ...
                                <div className="p-1 my-3 text-center text-white">
                                    ...
                                    <h2 className="px-3 pt-1 mt-1 text-lg leading-tight text-center">{data.title}</h2>
                                </div>
                            </a> : <div className="flex z-50 flex-col justify-center items-center">
                                <Image
                                    width={240}
                                    height={320}
                                    alt={data.alt}
